        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                CustomAuthHeader(backButton: true, title: 'Group Settings'),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: cyanGreen.withOpacity(0.5), width: 1),
          boxShadow: [
            BoxShadow(
        ...
        child: Icon(icon, size: 28.sp, color: darkGray),
      ),
    );
  }
